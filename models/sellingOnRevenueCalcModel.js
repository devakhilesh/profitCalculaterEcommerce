...
const sellingPriceCalcSchema = new mongoose.Schema(
  {
    ...
    calculationName: {
      type: String,
      trim: true,
      default: "Revenue & Selling Price Calculation",
    },
    // Input Parameters
    inputs: {
      dispatch: {
...
const SellingPriceOnRevenueCalculationModel = mongoose.model(
  "SellingPriceOnRevenueCalculation",
  sellingPriceCalcSchema
);

module.exports = SellingPriceOnRevenueCalculationModel;
